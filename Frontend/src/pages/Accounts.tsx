...
const Accounts = () => {
    ...
    const filteredSessions = sessions.filter(s =>
        s.accountNumber.toLowerCase().includes(searchTerm.toLowerCase()) ||
        s.bank.toLowerCase().includes(searchTerm.toLowerCase())
    );
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-5">
                                            <div className="flex flex-col items-center gap-1">
                                                <span className="text-lg font-bold font-mono">{session.riskScore}</span>
